...
import com.ctdi.cnos.llm.code.CodeGeneratorUIServer;
...
public class OutputFileInfoController {
    ...
    public Result getRootPath() {
        if (StrUtil.isNotEmpty(CodeGeneratorUIServer.SOURCE_PATH)) {
            projectPathResolver.refreshBaseProjectPath(CodeGeneratorUIServer.SOURCE_PATH);
        }
