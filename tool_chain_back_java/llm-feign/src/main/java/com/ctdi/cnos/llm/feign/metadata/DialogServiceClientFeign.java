...
public interface DialogServiceClientFeign {
     ...
     */
    @ApiOperation(value = "对话", notes = "对话")
    @PostMapping(value = "/dialog/conversation")
    OperateResult<ConversationResponse> conversation(@RequestBody ConversationBodyDTO conversationBody);
}