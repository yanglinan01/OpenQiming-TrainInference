 ...
 * @since 2024/12/06
 */
@Api(tags = "接口", value = "OrderUserController")
...
public class OrderUserController {
    ...
    public OperateResult<PageResult<OrderUserVO>> queryPage(@Validated(Groups.PAGE.class) @RequestBody QueryParam queryParam) {
    ...
    public OperateResult<List<OrderUserVO>> queryList(@RequestBody QueryParam queryParam) {
    ...
    public OperateResult<OrderUserVO> queryById(@ApiParam(value = "ID", required = true, example = "1")
    ...
    public OperateResult<String> add(@Validated(Groups.ADD.class) @RequestBody OrderUserDTO orderUserDTO) {
		OrderUser orderUser = ModelUtil.copyTo(orderUserDTO, OrderUser.class);
        return service.save(orderUser) ? OperateResult.successMessage(ApplicationConstant.SAVE_MESSAGE) : OperateResult.error(ErrorCodeEnum.DATA_SAVE_FAILED);
    }
    ...
    public OperateResult<String> updateById(@Validated(Groups.UPDATE.class) @RequestBody OrderUserDTO orderUserDTO) {
		OrderUser orderUser = ModelUtil.copyTo(orderUserDTO, OrderUser.class);
		return service.updateById(orderUser) ? OperateResult.successMessage(ApplicationConstant.UPDATE_MESSAGE) : OperateResult.error(ErrorCodeEnum.DATA_SAVE_FAILED);
    }
